...
count_data_df <- read.csv(file.path(work_dir, "Data/zebrafish_brain_count_data.csv"), row.names = "X")
meta_data_df <- read.csv(file.path(work_dir, "Data/zebrafish_brain_meta_data.csv"), row.names = "X")
